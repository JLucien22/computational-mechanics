...
wt=31
V=l*w*h
print("1a) The volume of the box is", V, "inches^3")
print("1b) The average density of the box is", (31/V/32.17))
print("1c) The result of the following logical operation is 'True'")
```
...
print("1b)", str1==str2)
print("1c)", str1>str2)
print("1d)", str1.lower()==str2.lower())
```
